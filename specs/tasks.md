...
- [x] Add SVG preview images for each Draw.io diagram under `/architecture` and add Markdown image references so GitHub reviewers can visualize diagrams in the repository. Related: Design Standards.
