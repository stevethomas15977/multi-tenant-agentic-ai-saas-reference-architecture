...
| REQ-API-001 | `design.md` Backend REST Routing; `/architecture/context-diagram.drawio`; `/architecture/container-diagram.drawio` | Define authorized endpoint source of truth; define UI action to API route mapping; define fail-closed endpoint behavior; define REST routing verification cases | Pending |
