...
| REQ-AUTHZ-011 | `cedar-avp.md`; `design.md` Cedar Authorization Model | Define AVP policy store schema provisioning; define Terraform AVP schema lifecycle | `verification.md` TM-AUTHZ-016 |
| REQ-AUTHZ-012 | `cedar-avp.md`; `design.md` Cedar Authorization Model | Define schema-aligned Cedar policy artifacts; define policy validation and bootstrap provisioning | `verification.md` TM-AUTHZ-017, TM-AUTHZ-018 |
...
| REQ-UI-003 | `design.md` Angular UI Layout; `angular-ui.md` | Define Angular shell layout; define tenant name display source; define Profile, Logout, and Help behavior | `verification.md` TM-UI-002 |
| REQ-UI-004 | `design.md` Angular UI Layout; `design.md` Authentication and Authorization Flow; `angular-ui.md` | Define Cedar-authorized action menu mapping; define authorized menu rendering cases | `verification.md` TM-AUTHZ-009, TM-UI-003 |
...
| REQ-UI-007 | `design.md` Angular UI Layout; `angular-ui.md` | Define persistent shell behavior; verify top navigation remains visible and unchanged during action transitions | `verification.md` TM-UI-001 |
| REQ-UI-008 | `angular-ui.md` | Define action-to-child-route mapping for starter navigation actions | `verification.md` TM-UI-003 |
| REQ-UI-009 | `angular-ui.md` | Define unauthorized direct child route guard behavior | `verification.md` TM-UI-004 |
