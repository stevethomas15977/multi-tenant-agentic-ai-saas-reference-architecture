...
| REQ-API-002 | `design.md` Backend REST Routing; `/architecture/context-diagram.drawio`; `/architecture/container-diagram.drawio` | Define API Gateway Lambda integration style; define Lambda function granularity and tenant isolation; define Lambda invocation verification cases | Pending |
