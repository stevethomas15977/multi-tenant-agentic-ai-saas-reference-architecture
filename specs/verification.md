...
| TM-AUTHZ-006 | REQ-AUTHZ-005 | User mapped to multiple same-tenant groups | All memberships included | Fixture or unit test |
| TM-AUTHZ-007 | REQ-AUTHZ-006 | Group assigned multiple actions | All grants available for decision | Fixture or unit test |
| TM-AUTHZ-008 | REQ-AUTHZ-006 | Duplicate group-action mapping | Single effective mapping | Fixture or unit test |
